...
class VoiceConfigManager(JsonManager):
    ...
    DEFAULTS: dict[str, Any] = {
        ...
        # Valores: normal | flow_gated | gated | very_gated.
        # flow_gated es el punto dulce para hablar de corrido: "pc apaga la luz".
        "audio_input_profile": "flow_gated",
        ...
        "continuous_min_speech_seconds": 0.48,
