...
class VoicePanel(ft.Column):
    ...
    def _build(self):
        ...
        self.setup_preset_dropdown = ft.Dropdown(
            ...
            width=230,
            options=[
                ft.DropdownOption(key="adaptive", text="Automático cerca/lejos"), ft.DropdownOption(key="voicemeeter", text="Voicemeeter recomendado"),
                ft.DropdownOption(key="far_field", text="Micrófono lejos"),
        ...
        self.audio_profile_dropdown = ft.Dropdown(
            ...
            width=230,
            options=[
                ft.DropdownOption(key="adaptive", text="Automático cerca/lejos"), ft.DropdownOption(key="flow_gated", text="Voicemeeter fluido"),
                ft.DropdownOption(key="far_field", text="Lejos / habitación"),
        ...
        main_card = self._card(
            ft.Column(
                [
                    ...
                    ft.Text("Punto dulce adaptativo: activador al inicio + modelo precargado + gobernador de recursos. Ej: pc apaga la luz.", color=Theme.FAINT, size=11),
                ],
                spacing=10,
            )
        )
        ...
        self.sensitivity_dropdown = ft.Dropdown(
            ...
            width=150,
            options=[ft.DropdownOption(key="0.0055", text="muy alta / lejos"), ft.DropdownOption(key="0.008", text="alta"), ft.DropdownOption(key="0.014", text="normal"), ft.DropdownOption(key="0.022", text="baja")],
            on_select=self._save_config,
            color=Theme.TEXT, bgcolor=Theme.BG, border_color=Theme.STROKE,
        )
