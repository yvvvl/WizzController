...
class RoutinesPanel(ft.Column):
    ...
    def _build(self):
        ...
        self.header = ft.ResponsiveRow(
            ...
            controls=[
                ...
                ft.Container(content=header_buttons, col={"xs": 12, "md": 5}, alignment=ft.Alignment.CENTER_RIGHT),
            ],
        )
        ...
        self.controls = [self.header, self.info_card, self.list_view]
        self._render()
    ...
    def _render(self):
        ...
        self._cards = [self.info_card] if hasattr(self, "info_card") else []
    ...
    def _routine_card(self, r: dict[str, Any]):
        ...
        return ft.Container(
            ...
            content=ft.ResponsiveRow(
                ...
                vertical_alignment=ft.CrossAxisAlignment.CENTER,
                controls=[
                    ft.Container(content=identity, col={"xs": 12, "md": 8}),
                    ft.Container(content=actions_row, col={"xs": 12, "md": 4}, alignment=ft.Alignment.CENTER_RIGHT),
                ],
            ),
        )
    ...
    def _open_editor(self, routine: dict[str, Any] | None = None):
        ...
        dialog_w, dialog_h = dialog_dimensions(self, 660, 640)
        identity = ft.ResponsiveRow(
            ...
            vertical_alignment=ft.CrossAxisAlignment.CENTER,
            controls=[
                ft.Container(content=color_preview, col={"xs": 12, "sm": 2}, alignment=ft.Alignment.CENTER),
                ft.Container(content=ft.Column([name, desc], spacing=8), col={"xs": 12, "sm": 10}),
            ],
        )
        style_row = ft.ResponsiveRow(
            breakpoints=PANEL_BREAKPOINTS,
            spacing=10,
            run_spacing=8,
            controls=[
                ft.Container(content=icon_dd, col={"xs": 12, "sm": 6}),
                ft.Container(content=color_field, col={"xs": 12, "sm": 6}),
            ],
        )
        actions_header = ft.ResponsiveRow(
            breakpoints=PANEL_BREAKPOINTS,
            spacing=8,
            run_spacing=6,
            vertical_alignment=ft.CrossAxisAlignment.CENTER,
    ...
    def _action_row(self, idx: int, action: dict[str, Any], actions: list[dict[str, Any]], rerender: Callable[[], None]):
        ...
        identity = ft.Row(
            [
                ft.Text(str(idx + 1), color=Theme.FAINT),
                ...
                ft.Column(
                    [
                        ft.Text(title, color=Theme.TEXT, weight=ft.FontWeight.W_600, size=13),
        ...
        return ft.Container(
            ...
            content=ft.ResponsiveRow(
                ...
                vertical_alignment=ft.CrossAxisAlignment.CENTER,
                controls=[
                    ft.Container(content=identity, col={"xs": 12, "sm": 8}),
                    ft.Container(content=controls, col={"xs": 12, "sm": 4}, alignment=ft.Alignment.CENTER_RIGHT),
                ],
            ),
        )
    ...
    def _open_action_dialog(self, action: dict[str, Any] | None, on_save: Callable[[dict[str, Any]], None], current_routine_id: str = ""):
        ...
        dialog_w, dialog_h = dialog_dimensions(self, 580, 580)
        identity = ft.ResponsiveRow(
            breakpoints=PANEL_BREAKPOINTS,
            spacing=12,
            run_spacing=8,
            ...
            controls=[
                ...
                ft.Container(content=ft.Column([kind, summary], spacing=6), col={"xs": 12, "sm": 10}),
            ],
        )
        dlg = ft.AlertDialog(
    ...
    def set_viewport(self, width: float, height: float, *, update: bool = True) -> None:
        ...
        if mode_changed:
            ...
            for card in self._cards:
                card.padding = 11 if viewport.compact else 12
            if update:
                supdate(self)
