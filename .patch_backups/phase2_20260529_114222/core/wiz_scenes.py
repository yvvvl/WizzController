"""
Fuente única de verdad para las escenas WiZ.
IDs alineados a la tabla oficial de WiZ Pro (1-33).

Antes tenías IDs contradictorios entre wiz_constants.py y wiz_scenes_data.py
(p.ej. "Cine" mandaba sceneId 12 = Daylight, no cine). Esto lo unifica.

Sin dependencias de Flet a propósito: la UI mapea el 'glyph'/'color' a sus widgets.
"""
...
class Scene:
    id: int
    name: str
    glyph: str       # emoji para la tarjeta
    color: str       # hex representativo
    dynamic: bool    # True si admite velocidad ajustable (20-200)
